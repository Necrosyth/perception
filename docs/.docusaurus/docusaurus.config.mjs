...
export default {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "links": [
        {
          ...
          "items": [
            {
              "label": "What is Surveillance Intelligence Lab?",
              "to": "/docs/intro"
            },
            {
              "label": "Quick start",
        ...
        },
        {
          ...
          "items": [
            {
              "label": "API reference",
              "to": "/docs/platform/api"
            },
            {
              "label": "Data layer",
              "to": "/docs/platform/data-layer"
            },
            {
              "label": "GPU acceleration",
              "to": "/docs/deployment/gpu-acceleration"
            }
          ]
        },
        {
      ...
      "copyright": "Copyright © 2026 Hypotenuse Analytics. Predict. Protect. Verify."
    },
    "prism": {
      "theme": {
        "plain": {
